...
def _format_timestamp(timestamp: int, timezone_offset: int, date_format_string: str) -> str:
    """Converts a UTC timestamp to a local time string using the provided format string."""
    utc_dt = datetime.datetime.fromtimestamp(timestamp, tz=datetime.timezone.utc)
    local_dt = utc_dt.astimezone(datetime.timezone(datetime.timedelta(seconds=timezone_offset)))
